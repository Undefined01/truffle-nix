 ...
 * </ul>
 */
@TruffleLanguage.Registration(id = NixLanguage.ID, name = "Nix", defaultMimeType = NixLanguage.MIME_TYPE, characterMimeTypes = NixLanguage.MIME_TYPE, contextPolicy = ContextPolicy.SHARED,
...
public final class NixLanguage extends TruffleLanguage<NixContext> {
    ...
    private static final Source BUILTIN_SOURCE = Source.newBuilder(NixLanguage.ID, "", "Nix builtin").build();
